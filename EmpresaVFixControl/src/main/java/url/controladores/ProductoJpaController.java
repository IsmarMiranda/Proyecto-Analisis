...
public class ProductoJpaController implements Serializable {
    ...
    public void actualizarExistencia(Producto producto){
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Query updateProducto = em.createNativeQuery("UPDATE Producto SET Producto.existencia=? WHERE Producto.codigo=?");
            updateProducto.setParameter(1,producto.getExistencia());
